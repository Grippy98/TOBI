SUMMARY = "TOBI-lite low-memory serial installer initramfs"
DESCRIPTION = "AM62-SIP focused TOBI initramfs that keeps the installer serial-only and trims unused kernel modules."
